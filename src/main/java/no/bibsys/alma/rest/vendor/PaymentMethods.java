...
public class PaymentMethods implements Serializable, Equals2, HashCode2, ToString2
{
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            ...
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "paymentMethod", thePaymentMethod), currentHashCode, thePaymentMethod, ((this.paymentMethod!= null)&&(!this.paymentMethod.isEmpty())));
        }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final PaymentMethods that = ((PaymentMethods) object);
        {
            ...
            lhsPaymentMethod = (((this.paymentMethod!= null)&&(!this.paymentMethod.isEmpty()))?this.getPaymentMethod():null);
            List<PaymentMethod> rhsPaymentMethod;
            rhsPaymentMethod = (((that.paymentMethod!= null)&&(!that.paymentMethod.isEmpty()))?that.getPaymentMethod():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "paymentMethod", lhsPaymentMethod), LocatorUtils.property(thatLocator, "paymentMethod", rhsPaymentMethod), lhsPaymentMethod, rhsPaymentMethod, ((this.paymentMethod!= null)&&(!this.paymentMethod.isEmpty())), ((that.paymentMethod!= null)&&(!that.paymentMethod.isEmpty())))) {
                return false;
            }
        }
        return true;
