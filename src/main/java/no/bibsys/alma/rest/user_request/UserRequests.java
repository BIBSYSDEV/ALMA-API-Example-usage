...
@XmlRootElement(name = "user_requests")
public class UserRequests implements Serializable, Equals2, HashCode2, ToString2
{
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            List<UserRequest> theUserRequest;
            theUserRequest = (((this.userRequest!= null)&&(!this.userRequest.isEmpty()))?this.getUserRequest():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "userRequest", theUserRequest), currentHashCode, theUserRequest, ((this.userRequest!= null)&&(!this.userRequest.isEmpty())));
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final UserRequests that = ((UserRequests) object);
        {
            List<UserRequest> lhsUserRequest;
            lhsUserRequest = (((this.userRequest!= null)&&(!this.userRequest.isEmpty()))?this.getUserRequest():null);
            List<UserRequest> rhsUserRequest;
            rhsUserRequest = (((that.userRequest!= null)&&(!that.userRequest.isEmpty()))?that.getUserRequest():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "userRequest", lhsUserRequest), LocatorUtils.property(thatLocator, "userRequest", rhsUserRequest), lhsUserRequest, rhsUserRequest, ((this.userRequest!= null)&&(!this.userRequest.isEmpty())), ((that.userRequest!= null)&&(!that.userRequest.isEmpty())))) {
                return false;
            }
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            List<UserRequest> theUserRequest;
            theUserRequest = (((this.userRequest!= null)&&(!this.userRequest.isEmpty()))?this.getUserRequest():null);
            strategy.appendField(locator, this, "userRequest", buffer, theUserRequest, ((this.userRequest!= null)&&(!this.userRequest.isEmpty())));
        }
        {
            Integer theTotalRecordCount;
            theTotalRecordCount = this.getTotalRecordCount();
