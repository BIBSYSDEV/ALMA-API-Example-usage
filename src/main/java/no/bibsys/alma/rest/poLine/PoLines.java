 ...
 * A list of po_lines.
 * 
 * <p>Java class for po_lines complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="po_lines"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="po_line" type="{}po_line" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "po_lines", propOrder = {
    "poLine"
})
@XmlRootElement(name = "po_lines")
public class PoLines implements Serializable, Equals2, HashCode2, ToString2
{
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            List<PoLine> thePoLine;
            thePoLine = (((this.poLine!= null)&&(!this.poLine.isEmpty()))?this.getPoLine():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "poLine", thePoLine), currentHashCode, thePoLine, ((this.poLine!= null)&&(!this.poLine.isEmpty())));
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final PoLines that = ((PoLines) object);
        {
            List<PoLine> lhsPoLine;
            lhsPoLine = (((this.poLine!= null)&&(!this.poLine.isEmpty()))?this.getPoLine():null);
            List<PoLine> rhsPoLine;
            rhsPoLine = (((that.poLine!= null)&&(!that.poLine.isEmpty()))?that.getPoLine():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "poLine", lhsPoLine), LocatorUtils.property(thatLocator, "poLine", rhsPoLine), lhsPoLine, rhsPoLine, ((this.poLine!= null)&&(!this.poLine.isEmpty())), ((that.poLine!= null)&&(!that.poLine.isEmpty())))) {
                return false;
            }
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            List<PoLine> thePoLine;
            thePoLine = (((this.poLine!= null)&&(!this.poLine.isEmpty()))?this.getPoLine():null);
            strategy.appendField(locator, this, "poLine", buffer, thePoLine, ((this.poLine!= null)&&(!this.poLine.isEmpty())));
        }
        {
            Integer theTotalRecordCount;
            theTotalRecordCount = this.getTotalRecordCount();
