 ...
 * A list of funds.
 * 
 * <p>Java class for funds complex type.
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="fund" type="{}fund" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class Funds implements Serializable, Equals2, HashCode2, ToString2
{
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            List<Fund> theFund;
            theFund = (((this.fund!= null)&&(!this.fund.isEmpty()))?this.getFund():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "fund", theFund), currentHashCode, theFund, ((this.fund!= null)&&(!this.fund.isEmpty())));
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final Funds that = ((Funds) object);
        {
            List<Fund> lhsFund;
            lhsFund = (((this.fund!= null)&&(!this.fund.isEmpty()))?this.getFund():null);
            List<Fund> rhsFund;
            rhsFund = (((that.fund!= null)&&(!that.fund.isEmpty()))?that.getFund():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "fund", lhsFund), LocatorUtils.property(thatLocator, "fund", rhsFund), lhsFund, rhsFund, ((this.fund!= null)&&(!this.fund.isEmpty())), ((that.fund!= null)&&(!that.fund.isEmpty())))) {
                return false;
            }
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            List<Fund> theFund;
            theFund = (((this.fund!= null)&&(!this.fund.isEmpty()))?this.getFund():null);
            strategy.appendField(locator, this, "fund", buffer, theFund, ((this.fund!= null)&&(!this.fund.isEmpty())));
        }
        {
            Integer theTotalRecordCount;
            theTotalRecordCount = this.getTotalRecordCount();
