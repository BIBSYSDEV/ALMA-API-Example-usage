...
public class KeywordsQueries implements Serializable, Equals2, HashCode2, ToString2
{
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            List<Queries> theQueries;
            theQueries = (((this.queries!= null)&&(!this.queries.isEmpty()))?this.getQueries():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "queries", theQueries), currentHashCode, theQueries, ((this.queries!= null)&&(!this.queries.isEmpty())));
        }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            List<Queries> lhsQueries;
            lhsQueries = (((this.queries!= null)&&(!this.queries.isEmpty()))?this.getQueries():null);
            List<Queries> rhsQueries;
            rhsQueries = (((that.queries!= null)&&(!that.queries.isEmpty()))?that.getQueries():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "queries", lhsQueries), LocatorUtils.property(thatLocator, "queries", rhsQueries), lhsQueries, rhsQueries, ((this.queries!= null)&&(!this.queries.isEmpty())), ((that.queries!= null)&&(!that.queries.isEmpty())))) {
                return false;
            }
        }
        return true;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            List<Queries> theQueries;
            theQueries = (((this.queries!= null)&&(!this.queries.isEmpty()))?this.getQueries():null);
            strategy.appendField(locator, this, "queries", buffer, theQueries, ((this.queries!= null)&&(!this.queries.isEmpty())));
        }
        return buffer;
    }
    ...
    public static class Queries implements Serializable, Equals2, HashCode2, ToString2
    {
