...
public class Partners implements Serializable, Equals2, HashCode2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            List<Partner> thePartner;
            thePartner = (((this.partner!= null)&&(!this.partner.isEmpty()))?this.getPartner():null);
            strategy.appendField(locator, this, "partner", buffer, thePartner, ((this.partner!= null)&&(!this.partner.isEmpty())));
        }
        {
            Integer theTotalRecordCount;
            theTotalRecordCount = this.getTotalRecordCount();
