...
public class UserStatistics implements Serializable, Equals2, HashCode2, ToString2
{
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            List<UserStatistic> theUserStatistic;
            theUserStatistic = (((this.userStatistic!= null)&&(!this.userStatistic.isEmpty()))?this.getUserStatistic():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "userStatistic", theUserStatistic), currentHashCode, theUserStatistic, ((this.userStatistic!= null)&&(!this.userStatistic.isEmpty())));
        }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final UserStatistics that = ((UserStatistics) object);
        {
            List<UserStatistic> lhsUserStatistic;
            lhsUserStatistic = (((this.userStatistic!= null)&&(!this.userStatistic.isEmpty()))?this.getUserStatistic():null);
            List<UserStatistic> rhsUserStatistic;
            rhsUserStatistic = (((that.userStatistic!= null)&&(!that.userStatistic.isEmpty()))?that.getUserStatistic():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "userStatistic", lhsUserStatistic), LocatorUtils.property(thatLocator, "userStatistic", rhsUserStatistic), lhsUserStatistic, rhsUserStatistic, ((this.userStatistic!= null)&&(!this.userStatistic.isEmpty())), ((that.userStatistic!= null)&&(!that.userStatistic.isEmpty())))) {
                return false;
            }
        }
        return true;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            List<UserStatistic> theUserStatistic;
            theUserStatistic = (((this.userStatistic!= null)&&(!this.userStatistic.isEmpty()))?this.getUserStatistic():null);
            strategy.appendField(locator, this, "userStatistic", buffer, theUserStatistic, ((this.userStatistic!= null)&&(!this.userStatistic.isEmpty())));
        }
        return buffer;
    }
