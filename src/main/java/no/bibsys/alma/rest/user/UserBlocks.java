...
public class UserBlocks implements Serializable, Equals2, HashCode2, ToString2
{
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            List<UserBlock> theUserBlock;
            theUserBlock = (((this.userBlock!= null)&&(!this.userBlock.isEmpty()))?this.getUserBlock():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "userBlock", theUserBlock), currentHashCode, theUserBlock, ((this.userBlock!= null)&&(!this.userBlock.isEmpty())));
        }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final UserBlocks that = ((UserBlocks) object);
        {
            List<UserBlock> lhsUserBlock;
            lhsUserBlock = (((this.userBlock!= null)&&(!this.userBlock.isEmpty()))?this.getUserBlock():null);
            List<UserBlock> rhsUserBlock;
            rhsUserBlock = (((that.userBlock!= null)&&(!that.userBlock.isEmpty()))?that.getUserBlock():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "userBlock", lhsUserBlock), LocatorUtils.property(thatLocator, "userBlock", rhsUserBlock), lhsUserBlock, rhsUserBlock, ((this.userBlock!= null)&&(!this.userBlock.isEmpty())), ((that.userBlock!= null)&&(!that.userBlock.isEmpty())))) {
                return false;
            }
        }
        return true;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            List<UserBlock> theUserBlock;
            theUserBlock = (((this.userBlock!= null)&&(!this.userBlock.isEmpty()))?this.getUserBlock():null);
            strategy.appendField(locator, this, "userBlock", buffer, theUserBlock, ((this.userBlock!= null)&&(!this.userBlock.isEmpty())));
        }
        return buffer;
    }
