...
public class AgencyAddressInformation implements Equals2, HashCode2, ToString2
{
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            SchemeValuePair theAgencyAddressRoleType;
            theAgencyAddressRoleType = this.getAgencyAddressRoleType();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "agencyAddressRoleType", theAgencyAddressRoleType), currentHashCode, theAgencyAddressRoleType, (this.agencyAddressRoleType!= null));
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final AgencyAddressInformation that = ((AgencyAddressInformation) object);
        {
            SchemeValuePair lhsAgencyAddressRoleType;
            lhsAgencyAddressRoleType = this.getAgencyAddressRoleType();
            SchemeValuePair rhsAgencyAddressRoleType;
            rhsAgencyAddressRoleType = that.getAgencyAddressRoleType();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "agencyAddressRoleType", lhsAgencyAddressRoleType), LocatorUtils.property(thatLocator, "agencyAddressRoleType", rhsAgencyAddressRoleType), lhsAgencyAddressRoleType, rhsAgencyAddressRoleType, (this.agencyAddressRoleType!= null), (that.agencyAddressRoleType!= null))) {
                return false;
            }
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            SchemeValuePair theAgencyAddressRoleType;
            theAgencyAddressRoleType = this.getAgencyAddressRoleType();
            strategy.appendField(locator, this, "agencyAddressRoleType", buffer, theAgencyAddressRoleType, (this.agencyAddressRoleType!= null));
        }
        {
            XMLGregorianCalendar theValidFromDate;
            theValidFromDate = this.getValidFromDate();
