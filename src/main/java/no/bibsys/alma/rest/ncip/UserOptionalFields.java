...
public class UserOptionalFields implements Equals2, HashCode2, ToString2
{
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the previousUserIds property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPreviousUserIds().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<PreviousUserId> getPreviousUserIds() {
        if (previousUserIds == null) {
            previousUserIds = new ArrayList<PreviousUserId>();
        }
        return this.previousUserIds;
    }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            List<UserId> theUserIds;
            theUserIds = (((this.userIds!= null)&&(!this.userIds.isEmpty()))?this.getUserIds():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "userIds", theUserIds), currentHashCode, theUserIds, ((this.userIds!= null)&&(!this.userIds.isEmpty())));
        }
        {
            List<PreviousUserId> thePreviousUserIds;
            thePreviousUserIds = (((this.previousUserIds!= null)&&(!this.previousUserIds.isEmpty()))?this.getPreviousUserIds():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "previousUserIds", thePreviousUserIds), currentHashCode, thePreviousUserIds, ((this.previousUserIds!= null)&&(!this.previousUserIds.isEmpty())));
        }
        {
            Ext theExt;
            theExt = this.getExt();
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final UserOptionalFields that = ((UserOptionalFields) object);
        {
        ...
        {
            List<UserId> lhsUserIds;
            lhsUserIds = (((this.userIds!= null)&&(!this.userIds.isEmpty()))?this.getUserIds():null);
            List<UserId> rhsUserIds;
            rhsUserIds = (((that.userIds!= null)&&(!that.userIds.isEmpty()))?that.getUserIds():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "userIds", lhsUserIds), LocatorUtils.property(thatLocator, "userIds", rhsUserIds), lhsUserIds, rhsUserIds, ((this.userIds!= null)&&(!this.userIds.isEmpty())), ((that.userIds!= null)&&(!that.userIds.isEmpty())))) {
                return false;
            }
        }
        {
            List<PreviousUserId> lhsPreviousUserIds;
            lhsPreviousUserIds = (((this.previousUserIds!= null)&&(!this.previousUserIds.isEmpty()))?this.getPreviousUserIds():null);
            List<PreviousUserId> rhsPreviousUserIds;
            rhsPreviousUserIds = (((that.previousUserIds!= null)&&(!that.previousUserIds.isEmpty()))?that.getPreviousUserIds():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "previousUserIds", lhsPreviousUserIds), LocatorUtils.property(thatLocator, "previousUserIds", rhsPreviousUserIds), lhsPreviousUserIds, rhsPreviousUserIds, ((this.previousUserIds!= null)&&(!this.previousUserIds.isEmpty())), ((that.previousUserIds!= null)&&(!that.previousUserIds.isEmpty())))) {
                return false;
            }
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            List<UserId> theUserIds;
            theUserIds = (((this.userIds!= null)&&(!this.userIds.isEmpty()))?this.getUserIds():null);
            strategy.appendField(locator, this, "userIds", buffer, theUserIds, ((this.userIds!= null)&&(!this.userIds.isEmpty())));
        }
        {
            List<PreviousUserId> thePreviousUserIds;
            thePreviousUserIds = (((this.previousUserIds!= null)&&(!this.previousUserIds.isEmpty()))?this.getPreviousUserIds():null);
            strategy.appendField(locator, this, "previousUserIds", buffer, thePreviousUserIds, ((this.previousUserIds!= null)&&(!this.previousUserIds.isEmpty())));
        }
        {
            Ext theExt;
            theExt = this.getExt();
