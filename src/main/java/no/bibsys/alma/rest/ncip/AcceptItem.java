...
public class AcceptItem implements Equals2, HashCode2, ToString2
{
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            SchemeValuePair theRequestedActionType;
            theRequestedActionType = this.getRequestedActionType();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "requestedActionType", theRequestedActionType), currentHashCode, theRequestedActionType, (this.requestedActionType!= null));
        }
        {
            UserId theUserId;
        ...
        {
            RenewalNotPermitted theRenewalNotPermitted;
            theRenewalNotPermitted = this.getRenewalNotPermitted();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "renewalNotPermitted", theRenewalNotPermitted), currentHashCode, theRenewalNotPermitted, (this.renewalNotPermitted!= null));
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final AcceptItem that = ((AcceptItem) object);
        {
        ...
        {
            SchemeValuePair lhsRequestedActionType;
            lhsRequestedActionType = this.getRequestedActionType();
            SchemeValuePair rhsRequestedActionType;
            rhsRequestedActionType = that.getRequestedActionType();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "requestedActionType", lhsRequestedActionType), LocatorUtils.property(thatLocator, "requestedActionType", rhsRequestedActionType), lhsRequestedActionType, rhsRequestedActionType, (this.requestedActionType!= null), (that.requestedActionType!= null))) {
                return false;
            }
        }
        {
        ...
        {
            RenewalNotPermitted lhsRenewalNotPermitted;
            lhsRenewalNotPermitted = this.getRenewalNotPermitted();
            RenewalNotPermitted rhsRenewalNotPermitted;
            rhsRenewalNotPermitted = that.getRenewalNotPermitted();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "renewalNotPermitted", lhsRenewalNotPermitted), LocatorUtils.property(thatLocator, "renewalNotPermitted", rhsRenewalNotPermitted), lhsRenewalNotPermitted, rhsRenewalNotPermitted, (this.renewalNotPermitted!= null), (that.renewalNotPermitted!= null))) {
                return false;
            }
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            SchemeValuePair theRequestedActionType;
            theRequestedActionType = this.getRequestedActionType();
            strategy.appendField(locator, this, "requestedActionType", buffer, theRequestedActionType, (this.requestedActionType!= null));
        }
        {
            UserId theUserId;
            theUserId = this.getUserId();
        ...
        }
        {
            RenewalNotPermitted theRenewalNotPermitted;
            theRenewalNotPermitted = this.getRenewalNotPermitted();
            strategy.appendField(locator, this, "renewalNotPermitted", buffer, theRenewalNotPermitted, (this.renewalNotPermitted!= null));
        }
        {
            FiscalTransactionInformation theFiscalTransactionInformation;
            theFiscalTransactionInformation = this.getFiscalTransactionInformation();
