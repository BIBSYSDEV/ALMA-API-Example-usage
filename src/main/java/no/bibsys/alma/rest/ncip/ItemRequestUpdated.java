...
public class ItemRequestUpdated implements Equals2, HashCode2, ToString2
{
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            DeleteRequestFields theDeleteRequestFields;
            theDeleteRequestFields = this.getDeleteRequestFields();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "deleteRequestFields", theDeleteRequestFields), currentHashCode, theDeleteRequestFields, (this.deleteRequestFields!= null));
        }
        {
            AddRequestFields theAddRequestFields;
            theAddRequestFields = this.getAddRequestFields();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "addRequestFields", theAddRequestFields), currentHashCode, theAddRequestFields, (this.addRequestFields!= null));
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ItemRequestUpdated that = ((ItemRequestUpdated) object);
        {
        ...
        {
            DeleteRequestFields lhsDeleteRequestFields;
            lhsDeleteRequestFields = this.getDeleteRequestFields();
            DeleteRequestFields rhsDeleteRequestFields;
            rhsDeleteRequestFields = that.getDeleteRequestFields();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "deleteRequestFields", lhsDeleteRequestFields), LocatorUtils.property(thatLocator, "deleteRequestFields", rhsDeleteRequestFields), lhsDeleteRequestFields, rhsDeleteRequestFields, (this.deleteRequestFields!= null), (that.deleteRequestFields!= null))) {
                return false;
            }
        }
        {
            AddRequestFields lhsAddRequestFields;
            lhsAddRequestFields = this.getAddRequestFields();
            AddRequestFields rhsAddRequestFields;
            rhsAddRequestFields = that.getAddRequestFields();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "addRequestFields", lhsAddRequestFields), LocatorUtils.property(thatLocator, "addRequestFields", rhsAddRequestFields), lhsAddRequestFields, rhsAddRequestFields, (this.addRequestFields!= null), (that.addRequestFields!= null))) {
                return false;
            }
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            DeleteRequestFields theDeleteRequestFields;
            theDeleteRequestFields = this.getDeleteRequestFields();
            strategy.appendField(locator, this, "deleteRequestFields", buffer, theDeleteRequestFields, (this.deleteRequestFields!= null));
        }
        {
            AddRequestFields theAddRequestFields;
            theAddRequestFields = this.getAddRequestFields();
            strategy.appendField(locator, this, "addRequestFields", buffer, theAddRequestFields, (this.addRequestFields!= null));
        }
        {
            ItemOptionalFields theItemOptionalFields;
            theItemOptionalFields = this.getItemOptionalFields();
