...
public class LookupAgency implements Equals2, HashCode2, ToString2
{
    ...
    protected List<SchemeValuePair> agencyElementTypes;
    @XmlElement(name = "Ext")
    protected Ext ext;
    ...
    /**
     * Gets the value of the agencyElementTypes property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the agencyElementTypes property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAgencyElementTypes().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<SchemeValuePair> getAgencyElementTypes() {
        if (agencyElementTypes == null) {
            agencyElementTypes = new ArrayList<SchemeValuePair>();
        }
        return this.agencyElementTypes;
    }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            List<SchemeValuePair> theAgencyElementTypes;
            theAgencyElementTypes = (((this.agencyElementTypes!= null)&&(!this.agencyElementTypes.isEmpty()))?this.getAgencyElementTypes():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "agencyElementTypes", theAgencyElementTypes), currentHashCode, theAgencyElementTypes, ((this.agencyElementTypes!= null)&&(!this.agencyElementTypes.isEmpty())));
        }
        {
            Ext theExt;
            theExt = this.getExt();
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final LookupAgency that = ((LookupAgency) object);
        {
        ...
        {
            List<SchemeValuePair> lhsAgencyElementTypes;
            lhsAgencyElementTypes = (((this.agencyElementTypes!= null)&&(!this.agencyElementTypes.isEmpty()))?this.getAgencyElementTypes():null);
            List<SchemeValuePair> rhsAgencyElementTypes;
            rhsAgencyElementTypes = (((that.agencyElementTypes!= null)&&(!that.agencyElementTypes.isEmpty()))?that.getAgencyElementTypes():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "agencyElementTypes", lhsAgencyElementTypes), LocatorUtils.property(thatLocator, "agencyElementTypes", rhsAgencyElementTypes), lhsAgencyElementTypes, rhsAgencyElementTypes, ((this.agencyElementTypes!= null)&&(!this.agencyElementTypes.isEmpty())), ((that.agencyElementTypes!= null)&&(!that.agencyElementTypes.isEmpty())))) {
                return false;
            }
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            List<SchemeValuePair> theAgencyElementTypes;
            theAgencyElementTypes = (((this.agencyElementTypes!= null)&&(!this.agencyElementTypes.isEmpty()))?this.getAgencyElementTypes():null);
            strategy.appendField(locator, this, "agencyElementTypes", buffer, theAgencyElementTypes, ((this.agencyElementTypes!= null)&&(!this.agencyElementTypes.isEmpty())));
        }
        {
            Ext theExt;
            theExt = this.getExt();
