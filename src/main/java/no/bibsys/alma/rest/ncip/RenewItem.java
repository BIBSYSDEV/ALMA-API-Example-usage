...
public class RenewItem implements Equals2, HashCode2, ToString2
{
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            XMLGregorianCalendar theDesiredDateForReturn;
            theDesiredDateForReturn = this.getDesiredDateForReturn();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "desiredDateForReturn", theDesiredDateForReturn), currentHashCode, theDesiredDateForReturn, (this.desiredDateForReturn!= null));
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final RenewItem that = ((RenewItem) object);
        {
        ...
        {
            XMLGregorianCalendar lhsDesiredDateForReturn;
            lhsDesiredDateForReturn = this.getDesiredDateForReturn();
            XMLGregorianCalendar rhsDesiredDateForReturn;
            rhsDesiredDateForReturn = that.getDesiredDateForReturn();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "desiredDateForReturn", lhsDesiredDateForReturn), LocatorUtils.property(thatLocator, "desiredDateForReturn", rhsDesiredDateForReturn), lhsDesiredDateForReturn, rhsDesiredDateForReturn, (this.desiredDateForReturn!= null), (that.desiredDateForReturn!= null))) {
                return false;
            }
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            XMLGregorianCalendar theDesiredDateForReturn;
            theDesiredDateForReturn = this.getDesiredDateForReturn();
            strategy.appendField(locator, this, "desiredDateForReturn", buffer, theDesiredDateForReturn, (this.desiredDateForReturn!= null));
        }
        {
            AcknowledgedFeeAmount theAcknowledgedFeeAmount;
            theAcknowledgedFeeAmount = this.getAcknowledgedFeeAmount();
