...
public class ItemCheckedIn implements Equals2, HashCode2, ToString2
{
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            RoutingInformation theRoutingInformation;
            theRoutingInformation = this.getRoutingInformation();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "routingInformation", theRoutingInformation), currentHashCode, theRoutingInformation, (this.routingInformation!= null));
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ItemCheckedIn that = ((ItemCheckedIn) object);
        {
        ...
        {
            RoutingInformation lhsRoutingInformation;
            lhsRoutingInformation = this.getRoutingInformation();
            RoutingInformation rhsRoutingInformation;
            rhsRoutingInformation = that.getRoutingInformation();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "routingInformation", lhsRoutingInformation), LocatorUtils.property(thatLocator, "routingInformation", rhsRoutingInformation), lhsRoutingInformation, rhsRoutingInformation, (this.routingInformation!= null), (that.routingInformation!= null))) {
                return false;
            }
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            RoutingInformation theRoutingInformation;
            theRoutingInformation = this.getRoutingInformation();
            strategy.appendField(locator, this, "routingInformation", buffer, theRoutingInformation, (this.routingInformation!= null));
        }
        {
            FiscalTransactionInformation theFiscalTransactionInformation;
            theFiscalTransactionInformation = this.getFiscalTransactionInformation();
