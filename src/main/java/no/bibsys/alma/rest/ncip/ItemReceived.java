...
public class ItemReceived implements Equals2, HashCode2, ToString2
{
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            XMLGregorianCalendar theDateReceived;
            theDateReceived = this.getDateReceived();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "dateReceived", theDateReceived), currentHashCode, theDateReceived, (this.dateReceived!= null));
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ItemReceived that = ((ItemReceived) object);
        {
        ...
        {
            XMLGregorianCalendar lhsDateReceived;
            lhsDateReceived = this.getDateReceived();
            XMLGregorianCalendar rhsDateReceived;
            rhsDateReceived = that.getDateReceived();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "dateReceived", lhsDateReceived), LocatorUtils.property(thatLocator, "dateReceived", rhsDateReceived), lhsDateReceived, rhsDateReceived, (this.dateReceived!= null), (that.dateReceived!= null))) {
                return false;
            }
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            XMLGregorianCalendar theDateReceived;
            theDateReceived = this.getDateReceived();
            strategy.appendField(locator, this, "dateReceived", buffer, theDateReceived, (this.dateReceived!= null));
        }
        {
            ItemOptionalFields theItemOptionalFields;
            theItemOptionalFields = this.getItemOptionalFields();
