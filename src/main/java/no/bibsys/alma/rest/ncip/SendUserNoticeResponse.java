...
public class SendUserNoticeResponse implements Equals2, HashCode2, ToString2
{
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            XMLGregorianCalendar theDateWillSend;
            theDateWillSend = this.getDateWillSend();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "dateWillSend", theDateWillSend), currentHashCode, theDateWillSend, (this.dateWillSend!= null));
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final SendUserNoticeResponse that = ((SendUserNoticeResponse) object);
        {
        ...
        {
            XMLGregorianCalendar lhsDateWillSend;
            lhsDateWillSend = this.getDateWillSend();
            XMLGregorianCalendar rhsDateWillSend;
            rhsDateWillSend = that.getDateWillSend();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "dateWillSend", lhsDateWillSend), LocatorUtils.property(thatLocator, "dateWillSend", rhsDateWillSend), lhsDateWillSend, rhsDateWillSend, (this.dateWillSend!= null), (that.dateWillSend!= null))) {
                return false;
            }
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            XMLGregorianCalendar theDateWillSend;
            theDateWillSend = this.getDateWillSend();
            strategy.appendField(locator, this, "dateWillSend", buffer, theDateWillSend, (this.dateWillSend!= null));
        }
        {
            XMLGregorianCalendar theDateSent;
            theDateSent = this.getDateSent();
