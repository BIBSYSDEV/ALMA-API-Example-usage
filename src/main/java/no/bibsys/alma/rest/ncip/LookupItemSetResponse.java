...
public class LookupItemSetResponse implements Equals2, HashCode2, ToString2
{
    ...
    /**
     * Gets the value of the bibInformations property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the bibInformations property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getBibInformations().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            List<BibInformation> theBibInformations;
            theBibInformations = (((this.bibInformations!= null)&&(!this.bibInformations.isEmpty()))?this.getBibInformations():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "bibInformations", theBibInformations), currentHashCode, theBibInformations, ((this.bibInformations!= null)&&(!this.bibInformations.isEmpty())));
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final LookupItemSetResponse that = ((LookupItemSetResponse) object);
        {
        ...
        {
            List<BibInformation> lhsBibInformations;
            lhsBibInformations = (((this.bibInformations!= null)&&(!this.bibInformations.isEmpty()))?this.getBibInformations():null);
            List<BibInformation> rhsBibInformations;
            rhsBibInformations = (((that.bibInformations!= null)&&(!that.bibInformations.isEmpty()))?that.getBibInformations():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "bibInformations", lhsBibInformations), LocatorUtils.property(thatLocator, "bibInformations", rhsBibInformations), lhsBibInformations, rhsBibInformations, ((this.bibInformations!= null)&&(!this.bibInformations.isEmpty())), ((that.bibInformations!= null)&&(!that.bibInformations.isEmpty())))) {
                return false;
            }
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            List<BibInformation> theBibInformations;
            theBibInformations = (((this.bibInformations!= null)&&(!this.bibInformations.isEmpty()))?this.getBibInformations():null);
            strategy.appendField(locator, this, "bibInformations", buffer, theBibInformations, ((this.bibInformations!= null)&&(!this.bibInformations.isEmpty())));
        }
        {
            String theNextItemToken;
            theNextItemToken = this.getNextItemToken();
