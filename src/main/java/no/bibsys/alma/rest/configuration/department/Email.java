...
/**
 * Specific department email address.
 * 
...
public class Email implements Serializable, Equals2, HashCode2, ToString2
{
    ...
    protected EmailTypes emailTypes;
     ...
     *     
     */
    public void setEmailTypes(EmailTypes value) {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            EmailTypes theEmailTypes;
            theEmailTypes = this.getEmailTypes();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "emailTypes", theEmailTypes), currentHashCode, theEmailTypes, (this.emailTypes!= null));
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            EmailTypes lhsEmailTypes;
            lhsEmailTypes = this.getEmailTypes();
            EmailTypes rhsEmailTypes;
            rhsEmailTypes = that.getEmailTypes();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "emailTypes", lhsEmailTypes), LocatorUtils.property(thatLocator, "emailTypes", rhsEmailTypes), lhsEmailTypes, rhsEmailTypes, (this.emailTypes!= null), (that.emailTypes!= null))) {
                return false;
            }
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            EmailTypes theEmailTypes;
            theEmailTypes = this.getEmailTypes();
            strategy.appendField(locator, this, "emailTypes", buffer, theEmailTypes, (this.emailTypes!= null));
        }
        {
            boolean thePreferred;
            thePreferred = ((this.preferred!= null)?this.isPreferred():false);
    ...
    public static class EmailTypes implements Serializable, Equals2, HashCode2, ToString2
    {

        @XmlElement(name = "email_type")
        protected List<EmailType> emailType;
        ...
        public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
            int currentHashCode = 1;
            {
                List<EmailType> theEmailType;
                theEmailType = (((this.emailType!= null)&&(!this.emailType.isEmpty()))?this.getEmailType():null);
                currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "emailType", theEmailType), currentHashCode, theEmailType, ((this.emailType!= null)&&(!this.emailType.isEmpty())));
            }
            return currentHashCode;
        }
        ...
        public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
            ...
            final EmailTypes that = ((EmailTypes) object);
            {
                List<EmailType> lhsEmailType;
                lhsEmailType = (((this.emailType!= null)&&(!this.emailType.isEmpty()))?this.getEmailType():null);
                List<EmailType> rhsEmailType;
                rhsEmailType = (((that.emailType!= null)&&(!that.emailType.isEmpty()))?that.getEmailType():null);
                if (!strategy.equals(LocatorUtils.property(thisLocator, "emailType", lhsEmailType), LocatorUtils.property(thatLocator, "emailType", rhsEmailType), lhsEmailType, rhsEmailType, ((this.emailType!= null)&&(!this.emailType.isEmpty())), ((that.emailType!= null)&&(!that.emailType.isEmpty())))) {
                    return false;
                }
            }
            return true;
        ...
        public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
            {
                List<EmailType> theEmailType;
                theEmailType = (((this.emailType!= null)&&(!this.emailType.isEmpty()))?this.getEmailType():null);
                strategy.appendField(locator, this, "emailType", buffer, theEmailType, ((this.emailType!= null)&&(!this.emailType.isEmpty())));
            }
            return buffer;
        }
        ...
        public static class EmailType implements Serializable, Equals2, HashCode2, ToString2
        {
