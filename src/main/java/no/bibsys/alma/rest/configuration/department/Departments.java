...
public class Departments implements Serializable, Equals2, HashCode2, ToString2
{
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            List<Department> theDepartment;
            theDepartment = (((this.department!= null)&&(!this.department.isEmpty()))?this.getDepartment():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "department", theDepartment), currentHashCode, theDepartment, ((this.department!= null)&&(!this.department.isEmpty())));
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final Departments that = ((Departments) object);
        {
            List<Department> lhsDepartment;
            lhsDepartment = (((this.department!= null)&&(!this.department.isEmpty()))?this.getDepartment():null);
            List<Department> rhsDepartment;
            rhsDepartment = (((that.department!= null)&&(!that.department.isEmpty()))?that.getDepartment():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "department", lhsDepartment), LocatorUtils.property(thatLocator, "department", rhsDepartment), lhsDepartment, rhsDepartment, ((this.department!= null)&&(!this.department.isEmpty())), ((that.department!= null)&&(!that.department.isEmpty())))) {
                return false;
            }
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            List<Department> theDepartment;
            theDepartment = (((this.department!= null)&&(!this.department.isEmpty()))?this.getDepartment():null);
            strategy.appendField(locator, this, "department", buffer, theDepartment, ((this.department!= null)&&(!this.department.isEmpty())));
        }
        {
            Integer theTotalRecordCount;
            theTotalRecordCount = this.getTotalRecordCount();
