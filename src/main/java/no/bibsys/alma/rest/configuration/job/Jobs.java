...
public class Jobs implements Serializable, Equals2, HashCode2, ToString2
{
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            List<Job> theJob;
            theJob = (((this.job!= null)&&(!this.job.isEmpty()))?this.getJob():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "job", theJob), currentHashCode, theJob, ((this.job!= null)&&(!this.job.isEmpty())));
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            List<Job> lhsJob;
            lhsJob = (((this.job!= null)&&(!this.job.isEmpty()))?this.getJob():null);
            List<Job> rhsJob;
            rhsJob = (((that.job!= null)&&(!that.job.isEmpty()))?that.getJob():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "job", lhsJob), LocatorUtils.property(thatLocator, "job", rhsJob), lhsJob, rhsJob, ((this.job!= null)&&(!this.job.isEmpty())), ((that.job!= null)&&(!that.job.isEmpty())))) {
                return false;
            }
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            List<Job> theJob;
            theJob = (((this.job!= null)&&(!this.job.isEmpty()))?this.getJob():null);
            strategy.appendField(locator, this, "job", buffer, theJob, ((this.job!= null)&&(!this.job.isEmpty())));
        }
        {
            Integer theTotalRecordCount;
            theTotalRecordCount = this.getTotalRecordCount();
