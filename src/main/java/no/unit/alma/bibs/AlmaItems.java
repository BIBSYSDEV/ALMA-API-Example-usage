...
public interface AlmaItems extends AlmaContext {
    ...
    ItemLoan createUserLoanOnItem(String barcode, String user_Id, String library, String circulationDesk, float fine, LoanStatus loanStatus);
    ...
    UserRequest createDigitizationRequest(String barcode, UserRequest.TargetDestination targetDestination, String message);

    UserRequest createDigitizationRequest(Item item, UserRequest.TargetDestination targetDestination, String message);

    UserRequest createDigitizationRequest(Item item, UserRequest.TargetDestination targetDestination, String message, String userId);
    ...
    UserRequest updateCommentOnRequest(String barcode, String requestId, String comment, boolean appendToExistingComment);
