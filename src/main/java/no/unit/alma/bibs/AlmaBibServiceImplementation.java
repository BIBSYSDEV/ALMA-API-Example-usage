...
class AlmaBibServiceImplementation implements AlmaBibService {
    ...
    AlmaBibServiceImplementation(AlmaClient almaClient) {
        this.bibsTarget = almaClient.getWebTarget().path("acq");
...
//    @Override
//    public boolean canBeDestroyed(String barcode, String context, String value, Set<String> validLibraries,
//            int minimumAge, int minimumItems) {
...
//
//    @Override
//    public boolean canBeDestroyed(Item item, String context, String value, Set<String> validLibraries, int minimumAge,
//            int minimumItems) {
...
//                                    publicationYear.replace("[", "").replace("]", "").replace("?", "")
//                                            .replace("cop.", "").replace("c", "").replace("<", "").replace(">", "")
//                                            .trim();
//                            try {
//                                year = Integer.parseInt(yearCandidate);
//                            } catch (NumberFormatException e2) {
//                                log.warn("Cannot parse year(260$c) in bibliographic record {}, content is {}",
//                                        bibRecord.getBib().getMmsId(), publicationYear);
//                            }
//
//                        }
...
//
//                Holdings holdings =
//                        RestJaxrsHoldings.Factory.create(context, value).getHoldings("" + mmsId).resultObject();
...
//                        List<AlmaResponse<Items>> items =
//                                RestJaxrsHoldings.Factory.create(context, value)
//                                        .getItems("" + mmsId, holding.getHoldingId()).responseList();
...
//                                    log.trace("Checking incoming label {} against candidateLabel: {}", label,
//                                            candidateLabel);
...
//                                        }
//                                        if (year + minimumAge > currentYear || year < 1900) {
//                                            log.trace("Candidate {} is out of year range..",
//                                                    candidate.getItemData().getBarcode());
//                                            return false;
//                                        }
//                                        itemCounter++;
//                                    }
...
//
//    @Override
//    public String createLabel(String enumerationA, String enumerationB, String enumerationC, String enumerationD,
